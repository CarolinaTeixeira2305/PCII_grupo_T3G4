...
import subs_gform_sessao as gfsessao
import subs_gformBilhete as gfBilhete
...
@app.route("/gformBilhete/<cname>", methods=["post","get"])
def gformBilhete(cname):
    cname="Bilhete"
    submenu = request.args.get("subm")
    return gfBilhete.gformBilhete(cname,submenu)
...
@app.route("/gform_sessao/<cname>", methods=["post","get"])
def gform_sessao(cname=''):
    submenu = request.args.get("subm")
    return gfsessao.gform_sessao(cname,submenu)
