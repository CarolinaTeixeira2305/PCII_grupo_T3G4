...
def gformBilhete(cname='',submenu=""):
    global prev_option
    ...
    if (ulogin != None):
        ...
        if option == 'insert' or len(cl.lst) == 0:
            ...
            for att in cl.att:
                obj[att] = ""
        return render_template("gformBilhete.html", butshow=butshow, butedit=butedit,
        ...
        return render_template("index.html", ulogin=ulogin)# -*- coding: utf-8 -*-
