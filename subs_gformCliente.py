...
def gformCliente(cname='',submenu=""):
    ...
    if (ulogin != None):
        ...
        return render_template("gformCliente.html", butshow=butshow, butedit=butedit,
                        cname=cname, obj=obj,objFilme=Filme.obj,objMenu=Menu.obj, filmes=filmes, menus=menus, att=cl.att,header=cl.header,des=cl.des,
                        ulogin=session.get("user"),ncliente=ulogin,
